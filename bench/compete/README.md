...
**adaptive tiling in the serial fallback** (so the few-big-triangle `fill` path the
pool can't split still gets the coarse-16 tile — pooled fill 3.2→2.6ms), and a
