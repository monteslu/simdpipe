...
export const SIMD = {
  ...
  v128_const: 0x0c, v128_and: 0x4e, v128_or: 0x50, v128_bitselect: 0x52, v128_any_true: 0x53,
  ...
  f32x4_floor: 0x68, f32x4_ceil: 0x67, f32x4_abs: 0xe1,
  f32x4_ge: 0x46, f32x4_lt: 0x43, f32x4_gt: 0x44, f32x4_le: 0x45,
  i32x4_add: 0xae, i32x4_shl: 0xab, i32x4_shr_u: 0xad, i32x4_trunc_sat_f32x4_s: 0xf8,
  i32x4_mul: 0xb5, i32x4_and: 0x4e,
  f32x4_convert_i32x4_s: 0xfa,
  // relaxed-SIMD fused multiply-add/sub: madd(a,b,c)=a*b+c, nmadd(a,b,c)=-(a*b)+c.
  // Single fused op (one rounding instead of two) → ≤1 LSB vs separate mul+add.
  // Opcodes 0x105/0x106 → 2-byte LEB; simd() handles the uleb for us.
  f32x4_relaxed_madd: 0x105, f32x4_relaxed_nmadd: 0x106,
  // lane access (take a 1-byte lane-index immediate after the opcode)
  i32x4_extract_lane: 0x1b, i32x4_replace_lane: 0x1c,
  f32x4_extract_lane: 0x1f, f32x4_replace_lane: 0x20,
  // i8x16.shuffle: two v128 operands + 16 byte-lane-index immediates (0..31).
  i8x16_shuffle: 0x0d,
};
