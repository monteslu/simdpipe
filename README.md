...
tiny-triangle work is setup-bound and gains less. These are early Phase-0 numbers
and will improve (tiled binning, threads, the fidelity fast-paths). Numbers are
...
- [ ] Threads — tiled binning + a worker pool (SIMD × cores)
